...
* Download a copy of this repo from the [Releases page](https://github.com/bosgood/ableton_komplete_kontrol_mk1/releases). Choose a version ending with `-patched`.
